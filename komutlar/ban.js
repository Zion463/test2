...
message.channel.send(new MessageEmbed().setDescription(`${message.author} tarafından ${kullanici} \`${sebep}\` Sebebiyle Sunucudan Yasaklandı.`).setImage("https://cdn.discordapp.com/attachments/719467531144003586/766932823839473684/ezgif-3-0a79e7496058.gif").setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setColor('0x348f36').setTimestamp()) 
